...
@responses.activate
def test_bond_daily_index_quotation(
    mock_openkrx_client: OpenKrxClient, mock_openkrx_client_url: str
):
    expected = {
        "OutBlock_1": [
    ...
    resp = mock_openkrx_client.get_bond_daily_index_quotation(
        bas_dd="20240514",
    )
...
@responses.activate
def test_derivative_daily_index_quotation(
    mock_openkrx_client: OpenKrxClient, mock_openkrx_client_url: str
):
    expected = {
        "OutBlock_1": [
    ...
    resp = mock_openkrx_client.get_derivatives_daily_index_quotation(
        bas_dd="20240514",
    )
