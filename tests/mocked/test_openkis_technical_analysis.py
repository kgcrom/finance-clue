...
class OpenKisTechnicalAnalysisTestCase(unittest.TestCase):
    ...
    def test_foreign_institution_total(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/foreign-institution-total",
            json=expected,
            status=200,
        )
    ...
    def test_program_trade_by_stock(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/program-trade-by-stock",
            json=expected,
            status=200,
        )
    ...
    def test_investor_trend_estimate(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/investor-trend-estimate",
            json=expected,
            status=200,
        )
    ...
    def test_trade_daily_volume(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-daily-trade-volume",
            json=expected,
            status=200,
        )
    ...
    def test_investor_time_by_market(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-investor-time-by-market",
            json=expected,
            status=200,
        )
    ...
    def test_credit_balance_daily(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/daily-credit-balance",
            json=expected,
            status=200,
        )
    ...
    def test_short_sale_daily(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/daily-short-sale",
            json=expected,
            status=200,
        )
    ...
    def test_program_trade_daily(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/comp-program-trade-daily",
            json=expected,
            status=200,
        )
    ...
    def test_overtime_expected_trans_fluct(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/ranking/overtime-exp-trans-fluct",
            json=expected,
            status=200,
        )
    ...
    def test_daily_loan_trans(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/daily-loan-trans",
            json=expected,
            status=200,
        )
    ...
    def test_program_trade_today(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/comp-program-trade-today",
            json=expected,
            status=200,
        )
    ...
    def test_foreign_trade_estimate(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/frgnmem-trade-estimate",
            json=expected,
            status=200,
        )
    ...
    def test_foreign_purchase_trend(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/frgnmem-pchs-trend",
            json=expected,
            status=200,
        )
    ...
    def test_trade_part_by_amount(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/tradprt-byamt",
            json=expected,
            status=200,
        )
    ...
    def test_investor_trend_by_market_daily(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-investor-daily-by-market",
            json=expected,
            status=200,
        )
    ...
    def test_program_trade_by_stock_daily(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/program-trade-by-stock-daily",
            json=expected,
            status=200,
        )
    ...
    def test_investor_program_trade_today(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/investor-program-trade-today",
            json=expected,
            status=200,
        )
    ...
    def test_capture_up_low_price(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/capture-uplowprice",
            json=expected,
            status=200,
        )
