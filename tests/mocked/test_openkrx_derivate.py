...
class OpenKrxDerivateTestCase(unittest.TestCase):
    ...
    def test_exclude_stock_futures(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkrx_client_url}/svc/apis/drv/fut_bydd_trd",
            json=expected,
            status=200,
        )
    ...
    def test_kospi_futures(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkrx_client_url}/svc/apis/drv/eqsfu_stk_bydd_trd",
            json=expected,
            status=200,
        )
    ...
    def test_kosdaq_futures(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkrx_client_url}/svc/apis/drv/eqkfu_ksq_bydd_trd",
            json=expected,
            status=200,
        )
    ...
    def test_exclude_stock_option(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkrx_client_url}/svc/apis/drv/opt_bydd_trd",
            json=expected,
            status=200,
        )
    ...
    def test_kospi_option(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkrx_client_url}/svc/apis/drv/eqsop_bydd_trd",
            json=expected,
            status=200,
        )
    ...
    def test_kosdaq_option(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkrx_client_url}/svc/apis/drv/eqkop_bydd_trd",
            json=expected,
            status=200,
        )
