...
class OpenKrxFinancialInstrumentTestCase(unittest.TestCase):
    ...
    def test_instrument_etf(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkrx_client_url}/svc/apis/etp/etf_bydd_trd",
            json=expected,
            status=200,
        )
    ...
    def test_instrument_etn(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkrx_client_url}/svc/apis/etp/etn_bydd_trd",
            json=expected,
            status=200,
        )
    ...
    def test_instrument_elw(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkrx_client_url}/svc/apis/etp/elw_bydd_trd",
            json=expected,
            status=200,
        )
