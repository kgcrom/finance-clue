...
class RegularDisclosureKeyCase(unittest.TestCase):
    ...
    def test_conditional_capital_not_reimbursed_balance(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/cndlCaplScritsNrdmpBlce.json",
            json=expected,
            status=200,
        )
    ...
    def test_corporate_bond_not_reimbursed_balance(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/cprndNrdmpBlce.json",
            json=expected,
            status=200,
        )
    ...
    def test_short_term_bond_not_reimbursed_balance(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/srtpdPsndbtNrdmpBlce.json",
            json=expected,
            status=200,
        )
    ...
    def test_enterprises_bill_not_reimbursed_balance(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/entrprsBilScritsNrdmpBlce.json",
            json=expected,
            status=200,
        )
    ...
    def test_debt_securities_issue_accomplishment(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/detScritsIsuAcmslt.json",
            json=expected,
            status=200,
        )
    ...
    def test_private_equity_capital_use_details(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/prvsrpCptalUseDtls.json",
            json=expected,
            status=200,
        )
    ...
    def test_public_equity_capital_use_details(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/pssrpCptalUseDtls.json",
            json=expected,
            status=200,
        )
    ...
    def test_director_audit_all_mending_status_shareholders_general_meeting_confirm_amount(
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/drctrAdtAllMendngSttusGmtsckConfmAmount.json",
            json=expected,
            status=200,
        )
    ...
    def test_director_audit_all_mending_status_mending_payment_amount_type_classification(
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/drctrAdtAllMendngSttusMendngPymntamtTyCl.json",
            json=expected,
            status=200,
        )
    ...
    def test_stock_total_quantity_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/stockTotqySttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_account_auditor_name_and_opinion(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/accnutAdtorNmNdAdtOpinion.json",
            json=expected,
            status=200,
        )
    ...
    def test_audit_service_conclusion_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/adtServcCnclsSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_account_auditor_non_audit_service_conclusion_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/accnutAdtorNonAdtServcCnclsSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_outside_director_change_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/outcmpnyDrctrNdChangeSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_new_capital_securities_not_reimbursed_balance(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/newCaplScritsNrdmpBlce.json",
            json=expected,
            status=200,
        )
    ...
    def test_increase_decrease_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/irdsSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_allocation_matter(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/alotMatter.json",
            json=expected,
            status=200,
        )
    ...
    def test_treasury_shares_acquisition_disposal_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/tesstkAcqsDspsSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_largest_shareholder_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/hyslrSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_largest_shareholder_change_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/hyslrChgSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_minority_shareholders_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/mrhlSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_executive_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/exctvSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_employee_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/empSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_director_auditor_individual_mending(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/hmvAuditIndvdlBySttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_director_audit_all_mending(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/hmvAuditAllSttus.json",
            json=expected,
            status=200,
        )
    ...
    def test_individual_by_pay(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/indvdlByPay.json",
            json=expected,
            status=200,
        )
    ...
    def test_outer_corporate_investment_status(self):
        ...
        responses.add(
            responses.GET,
            f"{self.opendart_client_url}/api/otrCprInvstmntSttus.json",
            json=expected,
            status=200,
        )
