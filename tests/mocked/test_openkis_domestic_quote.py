...
class DomesticQuoteCase(unittest.TestCase):
    ...
    @responses.activate
    def test_domestic_quotation_inquiry_price(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-price",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_price(fid_input_iscd="005930")

        assert resp == expected

    @responses.activate
    def test_domestic_quotation_inquiry_daily_price(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-daily-price",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_daily_price(
    ...
    @responses.activate
    def test_domestic_stock_daily_price(self):
        """국내주식 현재가 일자별 조회 mock test"""
        expected = {
            "output": [
                {
    ...
    @responses.activate
    def test_domestic_stock_quote_and_expected_conclusion(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-asking-price-exp-ccn",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_quote_and_expected_conclusion(
            fid_input_iscd="005930"
        )
    ...
    @responses.activate
    def test_domestic_stock_invest(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-investor",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_investor(
            fid_input_iscd="005930",
        )
    ...
    @responses.activate
    def test_domestic_stock_period_price(self):
        """"""
        expected = {
            "output1": {
                "prdy_vrss": "0",
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-daily-itemchartprice",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_period_price(
            fid_input_iscd="005930",
    ...
    @responses.activate
    def test_domestic_stock_time_conclusion(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-time-itemconclusion",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_time_conclusion(
            fid_input_iscd="005930",
    ...
    @responses.activate
    def test_domestic_stock_over_time_conclusion(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-time-overtimeconclusion",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_over_time_conclusion(
            fid_input_iscd="005930",
        )
    ...
    @responses.activate
    def test_domestic_stock_over_time_daily_price(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-daily-overtimeprice",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_over_time_daily_price(
            fid_input_iscd="005930",
        )
        assert resp == expected

    @responses.activate
    def test_domestic_stock_time_minute_price(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-time-itemchartprice",
            json=expected,
            status=200,
        )
        resp = self.openkis_client.get_domestic_stock_time_minute_price(
            fid_input_iscd="005930",
    ...
    @responses.activate
    def test_domestic_stock_price2(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-price-2",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_price2(fid_input_iscd="005930")
        assert resp == expected

    @responses.activate
    def test_domestic_stock_over_time_price(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-overtime-price",
            json=expected,
            status=200,
        )
        resp = self.openkis_client.get_domestic_stock_over_time_price(
            fid_input_iscd="005930",
        )
    ...
    @responses.activate
    def test_domestic_stock_over_time_quote(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-overtime-asking-price",
            json=expected,
            status=200,
        )
        resp = self.openkis_client.get_domestic_stock_over_time_quote(
            fid_input_iscd="005930",
        )
    ...
    @responses.activate
    def test_domestic_stock_closing_expected_conclusion(self):
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/exp-closing-price",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_closing_expected_conclusion(
            fid_input_iscd="0000"
        )
        assert resp == expected

    @responses.activate
    def test_domestic_stock_vi_status(self):
        expected = {
            "output": [
                {
                    "hts_kor_isnm": "유아이디",
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/inquire-vi-status",
            json=expected,
            status=200,
        )
        resp = self.openkis_client.get_vi_status(
            fid_input_iscd="",
    ...
    @responses.activate
    def test_domestic_stock_credit_by_company(self):
        expected = {
            "output": [
                {
                    "stck_shrn_iscd": "000020",
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/credit-by-company",
            json=expected,
            status=200,
        )
        resp = self.openkis_client.get_financial_credit_by_company(
            fid_input_iscd="0000"
        )
    ...
    @responses.activate
    def test_domestic_stock_invest_opinion(self):
        expected = {
            "output": [
                {
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/invest-opinion",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.get_domestic_stock_invest_opinion(
            fid_input_iscd="005930",
            fid_input_date1="20240126",
    ...
    @responses.activate
    def test_domestic_stock_check_holiday(self):
        expected = {
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/chk-holiday",
            json=expected,
            status=200,
        )
        resp = self.openkis_client.check_domestic_holiday(bass_dt="20240611")
        assert resp == expected

    @responses.activate
    def test_domestic_stock_search_product_info(self):
        expected = {
            "output": {
                "pdno": "AAPL",
                "prdt_type_cd": "512",
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/search-info",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.search_product_info(pdno="AAPL", prdt_type_cd="512")

        assert resp == expected

    @responses.activate
    def test_domestic_stock_search_stock_info(self):
        expected = {
            "output": {
                "pdno": "00000A000660",
                "prdt_type_cd": "300",
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/search-stock-info",
            json=expected,
            status=200,
        )

        resp = self.openkis_client.search_stock_info(pdno="000660", prdt_type_cd="300")

        assert resp == expected

    @responses.activate
    def test_domestic_stock_securities_opinion(self):
        expected = {
            "output": [
                {
        ...
        responses.add(
            responses.GET,
            f"{self.openkis_client_url}/uapi/domestic-stock/v1/quotations/invest-opbysec",
            json=expected,
            status=200,
        )
        resp = self.openkis_client.get_domestic_stock_securities_opinion(
            fid_input_iscd="999",
