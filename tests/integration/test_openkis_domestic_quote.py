...
class DomesticQuoteCase(unittest.TestCase):
    ...
    def test_domestic_stock_price(self):
    ...
    def test_domestic_stock_conclusion(self):
        resp = self.openkis_client.get_domestic_stock_conclusion(
    ...
    def test_domestic_stock_daily_price(self):
        ...
        assert all(
            [
                item["prdy_vrss_sign"] in ("1", "2", "3", "4", "5")
    ...
    def test_domestic_stock_investor(self):
    ...
    def test_domestic_stock_member(self):
        resp = self.openkis_client.get_domestic_stock_member(
            fid_input_iscd="005930", cls=attach_headers()
        )
    ...
    def test_domestic_stock_period_price(self):
        ...
        assert resp["rt_cd"] == "0"
        assert resp["output1"]["hts_kor_isnm"] == "삼성전자"
        assert len(resp["output2"]) == 8
    ...
    def test_domestic_stock_price2(self):
        resp = self.openkis_client.get_domestic_stock_price2(
            fid_input_iscd="005930",
        )
    ...
    def test_domestic_stock_closing_epxected_conclusion(self):
