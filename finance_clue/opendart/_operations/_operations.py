...
def build_gen_open_dart_list_disclosure_info_request(  # pylint: disable=name-too-long
    *,
    ...
    **kwargs: Any,
    ...
    if pblntf_detail_ty is not None:
        _params["pblntf_detail_ty"] = _SERIALIZER.query(
            "pblntf_detail_ty", pblntf_detail_ty, "str", max_length=8, min_length=8
        )
