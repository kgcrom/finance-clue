...
class GenOpenKisClient(
    ...
    :keyword endpoint: Service URL. Known values are: "https://openapi.koreainvestment.com:9443"
     and "https://openapivts.koreainvestment.com:29443". Default value is
    ...
    async def __aenter__(self) -> "GenOpenKisClient":
